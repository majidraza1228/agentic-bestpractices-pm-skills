...
**PM Skills** (`majidraza1228/agentic-bestpractices-pm-skills`) — a marketplace of **10 independent plugins** (72 skills, 44 commands) that bring structured product-management workflows to AI coding assistants. Built for Claude Code and Claude Cowork; the skills are also compatible with other agents (Gemini CLI, Cursor, Codex CLI).

Owner: Syed Raza — majidraza@gmail.com
